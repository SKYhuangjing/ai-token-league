...
- **macOS Apple silicon**: `AI Token League-0.7.9-mac-arm64-installer.dmg`
- **macOS Intel**: `AI Token League-0.7.9-mac-x64-installer.dmg`
- **Windows x64**: `AI Token League-0.7.9-win-x64-installer.exe`
