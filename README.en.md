...
- **macOS Apple silicon**: `AI Token League-0.7.3-mac-arm64-installer.dmg`
- **macOS Intel**: `AI Token League-0.7.3-mac-x64-installer.dmg`
- **Windows x64**: `AI Token League-0.7.3-win-x64-installer.exe`
