...
- **macOS Apple silicon**: `AI Token League-0.7.11-mac-arm64-installer.dmg`
- **macOS Intel**: `AI Token League-0.7.11-mac-x64-installer.dmg`
- **Windows x64**: `AI Token League-0.7.11-win-x64-installer.exe`
...
- Release manifest dry run: `node scripts/publish-release.js --env env.local --dry-run --full`
