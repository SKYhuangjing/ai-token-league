...
impl Command {
    pub fn from_str(s: &str) -> Option<Self> {
        match s {
            ...
            "ping" => Some(Self::Ping),
            "modules:get" => Some(Self::ModulesGet),
            "modules:set" => Some(Self::ModulesSet),
            "modules:package-get" => Some(Self::ModulesPackageGet),
            "modules:package-put" => Some(Self::ModulesPackagePut),
...
mod tests {
    ...
    fn test_command_from_str_all_known_commands() {
        let commands = [
            ...
            ("ping", Command::Ping),
            ("modules:get", Command::ModulesGet),
            ("modules:set", Command::ModulesSet),
            ("modules:package-get", Command::ModulesPackageGet),
            ("modules:package-put", Command::ModulesPackagePut),
