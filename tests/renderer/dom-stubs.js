...
const ALL_IDS = [
  ...
  'close-trend-drawer','cloud-status-badge','cloud-status-text',
  'cloud-sync-details','cloud-sync-diagnostics','cloud-sync-primary-action',
  'cloud-sync-status-badge','cloud-sync-status-detail','connect-cursor',
  ...
  'nickname','overview-cache-tokens','overview-input-tokens','overview-output-tokens',
  'overview-range','overview-trend','overview-trend-axis','overview-trend-summary',
  'provider-list','rail-cloud-status','rail-cloud-status-text','rail-last-scan',
  ...
  'save-cursor-token','settings-save-message','settings-source-list','settings-tabs',
