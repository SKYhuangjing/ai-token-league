...
const translations = {
  "zh-CN": {
    ...
    "desktop.sharing.owner.endpointWarn": "端点警告",
    ...
    "desktop.sharing.borrow.sectionConfig": "接入配置",
    "desktop.sharing.borrow.filterAll": "全部",
    "desktop.sharing.borrow.onlyAvailable": "只看可认领",
    "desktop.sharing.borrow.expandLanes": "展开其余 {n} 条车道",
    "desktop.sharing.borrow.collapseLanes": "收起车道",
    "desktop.sharing.borrow.hiddenGroup": "暂不可认领（{n}）",
    "desktop.sharing.borrow.hiddenNote": "{n} 个节点暂不可认领（耗尽 / 满员 / 暂停）",
    "desktop.sharing.borrow.emptyFiltered": "没有匹配的可认领车道。",
    "desktop.sharing.borrow.clearFilter": "清除过滤",
    "desktop.sharing.borrow.tooManyClaims": "你有 {active} 把有效 Key（上限 {max}），先撤销再认领",
    "desktop.sharing.borrow.sectionTest": "连通测试",
    "desktop.sharing.borrow.label.openaiUrl": "OpenAI 地址",
    "desktop.sharing.borrow.label.openaiKey": "OpenAI Key",
    "desktop.sharing.borrow.label.anthropicUrl": "Anthropic 地址",
    "desktop.sharing.borrow.label.anthropicToken": "Anthropic Token",
  ...
  "en": {
    ...
    "desktop.sharing.owner.endpointWarn": "Endpoint warning",
    ...
    "desktop.sharing.borrow.sectionConfig": "Connection",
    "desktop.sharing.borrow.filterAll": "All",
    "desktop.sharing.borrow.onlyAvailable": "Claimable only",
    "desktop.sharing.borrow.expandLanes": "Show {n} more lanes",
    "desktop.sharing.borrow.collapseLanes": "Collapse lanes",
    "desktop.sharing.borrow.hiddenGroup": "Not claimable ({n})",
    "desktop.sharing.borrow.hiddenNote": "{n} nodes not claimable right now (exhausted / full / paused)",
    "desktop.sharing.borrow.emptyFiltered": "No claimable lanes match this filter.",
    "desktop.sharing.borrow.clearFilter": "Clear filter",
    "desktop.sharing.borrow.tooManyClaims": "You hold {active} active keys (limit {max}); revoke one first",
    "desktop.sharing.borrow.sectionTest": "Connectivity test",
    "desktop.sharing.borrow.label.openaiUrl": "OpenAI URL",
    "desktop.sharing.borrow.label.openaiKey": "OpenAI Key",
    "desktop.sharing.borrow.label.anthropicUrl": "Anthropic URL",
    "desktop.sharing.borrow.label.anthropicToken": "Anthropic Token",
