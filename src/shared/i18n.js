...
const translations = {
  "zh-CN": {
    ...
    "desktop.sharing.owner.stopConfirm": "停止分享并撤销全部认领 Key？（恢复需在云端管理页 resume）",
  ...
  "en": {
    ...
    "desktop.sharing.owner.title": "Share console",    "desktop.sharing.owner.title": "Share console",
    ...
    "desktop.sharing.owner.f.keyConc": "Per-key conc.",
    ...
    "desktop.sharing.owner.stopConfirm": "Stop sharing and revoke all claim keys? (Resume from the cloud admin page.)",
