...
const translations = {
  "zh-CN": {
    ...
    "desktop.overview.rangeRows": "{range} · {count} 条本地每日记录",
    "desktop.overview.trend.today": "近 7 天（每日）",
    ...
    "desktop.backup.restore": "从备份恢复",
    "desktop.backup.directory": "备份文件夹",
    "desktop.backup.retention": "保留最近备份",
    "desktop.backup.chooseFolder": "选择文件夹",
    "desktop.backup.reveal": "在 Finder 中显示",
    "desktop.backup.noBackups": "还没有本机备份。",
    "desktop.backup.sensitiveDesc": "包含身份密钥、本机 token、缓存、队列和同步状态。",
    ...
    "desktop.diagnostics.clearRuntimeLog": "清理运行日志",
    "desktop.diagnostics.logSize": "大小 {size}",
    "desktop.diagnostics.logEvents": "{count} 条事件",
    "desktop.diagnostics.latestEvent": "最近 {time}",
    "desktop.diagnostics.retention": "自动保留最近 {count} 条或 {size}",
    ...
    "desktop.renderer.backupExported": "本机备份已完成，当前保留 {count} 份",
  ...
  "en": {
    ...
    "desktop.overview.rangeRows": "{range} · {count} local daily rows",
    "desktop.overview.trend.today": "Last 7 days (Daily)",
    ...
    "desktop.backup.restore": "Restore from backup",
    "desktop.backup.directory": "Backup folder",
    "desktop.backup.retention": "Keep recent backups",
    "desktop.backup.chooseFolder": "Choose folder",
    "desktop.backup.reveal": "Show in Finder",
    "desktop.backup.noBackups": "No local backups yet.",
    "desktop.backup.sensitiveDesc": "Includes identity keys, local tokens, cache, queue, and sync state.",
    ...
    "desktop.diagnostics.clearRuntimeLog": "Clear runtime log",
    "desktop.diagnostics.logSize": "Size {size}",
    "desktop.diagnostics.logEvents": "{count} events",
    "desktop.diagnostics.latestEvent": "Latest {time}",
    "desktop.diagnostics.retention": "Auto keeps recent {count} events or {size}",
    ...
    "desktop.renderer.backupExported": "Local backup complete. Keeping {count} backups.",
